...
const projects = [
  {
    title: "L'Odeur de l'Été",
    type: "court-métrage",
    credit: "écrit et réalisé par Bastien Louessard",
    prod: "Produit par Asmar Production x OMEN Films",
    stills: [
      "stills/l-odeur-de-l-ete/01.jpg",
      "stills/l-odeur-de-l-ete/02.jpg",
      "stills/l-odeur-de-l-ete/03.jpg",
      "stills/l-odeur-de-l-ete/04.jpg",
      "stills/l-odeur-de-l-ete/05.jpg",
      "stills/l-odeur-de-l-ete/06.jpg",
      "stills/l-odeur-de-l-ete/07.jpg",
      "stills/l-odeur-de-l-ete/08.jpg",
      "stills/l-odeur-de-l-ete/09.jpg"
    ]
  },
  {
    title: "Bvlgari",
    type: "publicité",
    credit: "écrit et réalisé par Corentin Huard",
    prod: "Produit par 1001 Films Production",
    stills: [
      "stills/bvlgari/01.jpg",
      "stills/bvlgari/02.jpg",
      "stills/bvlgari/03.jpg",
      "stills/bvlgari/04.jpg",
      "stills/bvlgari/05.jpg",
      "stills/bvlgari/06.jpg",
      "stills/bvlgari/07.jpg",
      "stills/bvlgari/08.jpg",
      "stills/bvlgari/09.jpg"
    ]
  },
  {
    title: "Rose d'Hiver",
    type: "court-métrage",
    credit: "écrit et réalisé par Alexis Rousseau",
    prod: "Produit par OMEN Films",
    stills: [
      "stills/rose-d-hiver/01.jpg",
      "stills/rose-d-hiver/02.jpg",
      "stills/rose-d-hiver/03.jpg",
      "stills/rose-d-hiver/04.jpg",
      "stills/rose-d-hiver/05.jpg",
      "stills/rose-d-hiver/06.jpg"
    ]
  },
  {
    title: "Sur Le Sentier",
    type: "long-métrage",
    credit: "écrit et réalisé par Gérard Jumel",
    prod: "Produit par JOUR J Productions",
    stills: [
      "stills/sur-le-sentier/01.jpg",
      "stills/sur-le-sentier/02.jpg",
      "stills/sur-le-sentier/03.jpg",
      "stills/sur-le-sentier/04.jpg",
      "stills/sur-le-sentier/05.jpg",
      "stills/sur-le-sentier/06.jpg"
    ]
  },
  {
    title: "Pietragalla Danse Barbara",
    type: "teaser promotionnel / danse",
    credit: "mis en scène par Julien Derouault & Marie-Claude Pietragalla",
    prod: "Seul en scène de Pietra — Le Théâtre du Corps Pietragalla-Derouault",
    stills: [
      "stills/pietragalla-danse-barbara/01.jpg",
      "stills/pietragalla-danse-barbara/02.jpg",
      "stills/pietragalla-danse-barbara/03.jpg",
      "stills/pietragalla-danse-barbara/04.jpg",
      "stills/pietragalla-danse-barbara/05.jpg",
      "stills/pietragalla-danse-barbara/06.jpg"
    ]
  },
  {
    title: "OSEF Le Paradis",
    type: "court-métrage",
    credit: "réalisé par Quentin Dufournet-Charles",
    prod: "Produit par Pimento Films avec le soutien du CNC et de Arté",
    diffusion: "Diffusion télé + streaming sur Arté",
    stills: [
      "stills/osef-le-paradis/01.jpg",
      "stills/osef-le-paradis/02.jpg",
      "stills/osef-le-paradis/03.jpg",
      "stills/osef-le-paradis/04.jpg",
      "stills/osef-le-paradis/05.jpg",
      "stills/osef-le-paradis/06.jpg"
    ]
  },
  {
    title: "Des Vacances à Tout Prix",
    type: "long-métrage",
    credit: "réalisé par Stevan Lee Mraovitch",
    prod: "Produit par Charlotte Russe Films avec le soutien du CNC",
    diffusion: "Diffusion festivals internationaux + streaming sur tubitv.com (U.S. seulement)",
    stills: [
      "stills/des-vacances-a-tout-prix/01.jpg",
      "stills/des-vacances-a-tout-prix/02.jpg",
      "stills/des-vacances-a-tout-prix/03.jpg",
      "stills/des-vacances-a-tout-prix/04.jpg",
      "stills/des-vacances-a-tout-prix/05.jpg",
      "stills/des-vacances-a-tout-prix/06.jpg"
    ]
  },
  {
    title: "FARIO",
    type: "long-métrage",
    credit: "réalisé par Gérard Jumel",
    prod: "Produit par Jour J Productions",
    diffusion: "Diffusion festivals + sortie salles indépendantes",
    stills: [
      "stills/fario/01.jpg",
      "stills/fario/02.jpg",
      "stills/fario/03.jpg",
  ...
  {
    title: "Far Cry 5 — Shadow",
    type: "publicité",
    credit: "réalisé par Léo Wolfenstein",
    prod: "Produit par Cléo Productions",
    stills: [
      "stills/far-cry-5-shadow/01.jpg",
      "stills/far-cry-5-shadow/02.jpg",
      "stills/far-cry-5-shadow/03.jpg",
      "stills/far-cry-5-shadow/04.jpg",
      "stills/far-cry-5-shadow/05.jpg",
      "stills/far-cry-5-shadow/06.jpg"
    ]
  },
  {
    title: "Call Me Nina",
    type: "publicité — fashion week",
    credit: "réalisé par Gabriel Maz",
    prod: "Film promotionnel pour la nouvelle collection du créateur Victor Weinsanto",
    stills: [
      "stills/call-me-nina/01.jpg",
      "stills/call-me-nina/02.jpg",
      "stills/call-me-nina/03.jpg",
      "stills/call-me-nina/04.jpg",
      "stills/call-me-nina/05.jpg",
      "stills/call-me-nina/06.jpg"
    ]
  }
];

// Toutes les images sont servies localement depuis le dossier assets/.
// Chaque projet a son propre sous-dossier (assets/stills/<slug-du-projet>/),
// avec les photos numérotées 01.jpg, 02.jpg, etc. dans l'ordre d'affichage.
// Il n'y a plus de génération de vignette à la volée (c'était une fonctionnalité
// propre à Wix) : thumb() et full() pointent vers le même fichier. Si vous
// voulez des vignettes plus légères, vous pouvez exporter deux versions et
// adapter ces deux fonctions.
const IMG_BASE = "assets/";
const thumb = s => `${IMG_BASE}${s}`;
const full  = s => `${IMG_BASE}${s}`;

/* ---------- hero video ---------- */
// Poster affiché tant que la vidéo n'est pas chargée (première still du premier projet)
document.getElementById('heroVideo').poster = full(projects[0].stills[0]);
...
function stillsMarkup(p, i){
  ...
  // il n'y a plus de fenêtre de 3 ni de pagination.
  return p.stills.map((s, idx) => `
    <button data-project="${i}" data-index="${idx}">
      <img src="${thumb(s)}" loading="lazy" alt="${p.title} — still ${idx+1}">
    </button>
  `).join('');
}
...
function renderStills(i){
  ...
  container.querySelectorAll('img').forEach(img => {
    if(img.complete) updateRowRatio(i);
    else img.addEventListener('load', () => updateRowRatio(i), { once:true });
  });
}

// Les stills d'un même projet n'ont pas toujours EXACTEMENT le même ratio
// (léger recadrage, export différent...). On applique donc la moyenne des
// ratios réels de toutes les photos du projet à toute la ligne : ça
// harmonise leur hauteur sans jamais recadrer une image (object-fit:contain).
function updateRowRatio(i){
  const container = projectList.querySelector(`.stills[data-project-stills="${i}"]`);
  if(!container) return;
  const ratios = [...container.querySelectorAll('img')]
    .filter(img => img.complete && img.naturalWidth && img.naturalHeight)
    .map(img => img.naturalWidth / img.naturalHeight);
  if(ratios.length === 0) return;
  const avg = ratios.reduce((a, b) => a + b, 0) / ratios.length;
  container.style.setProperty('--row-ratio', avg);
}
  ...
  row.innerHTML = `
    <div class="project-block">
      <div class="project-meta">
        ...
        <p class="credit"><strong>${p.prod}</strong></p>
...
bioBody.innerHTML = `
  ...
  <div class="bio-photo-wrap">
    <img class="bio-photo" src="assets/paul-portrait.webp" alt="Paul Olinger Ost">
  </div>
`;
