...
// Les photos de assets/pics/ sont nommées photo-01.webp, photo-02.webp, etc.
// Pour ajouter ou retirer des photos : déposez/enlevez les fichiers dans
// assets/pics/ (en gardant la numérotation continue à partir de 01) et
// mettez à jour PICS_COUNT ci-dessous avec le nombre total de photos.
const PICS_COUNT = 33;
const picsPhotos = Array.from({ length: PICS_COUNT }, (_, i) => {
  const num = String(i + 1).padStart(2, '0');
  return { src: `assets/pics/photo-${num}.webp`, alt: `Paul Olinger Ost — photo ${num}` };
});
